		...
		<div class="row">
			...
			<div class="col-md-12 content-area" id="primary">
				<main class="site-main" id="main" role="main">
					<h2 class="align-center">Salle de douche</h2>
					<div id="img-photo-template">
						...
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/01.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/31.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/36.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/37.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/40.jpg" alt="" style="width:20%;max-width:300px">
					</div>
					<!-- The Modal -->
