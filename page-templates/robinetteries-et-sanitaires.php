<?php
/**
 * Template Name: Robinetteries et sanitaires
		...
		<div class="row">
			...
			<div class="col-md-12 content-area" id="primary">
				<main class="site-main" id="main" role="main">
					<h2 class="align-center">Robinetteries et sanitaires</h2>
					<div id="img-photo-template">
						...
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/30.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/32.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/33.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/35.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/41.jpg" alt="" style="width:20%;max-width:300px">
						<img class="myImg" src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/11/28.jpg" alt="" style="width:20%;max-width:300px">
